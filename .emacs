...
;;(global-set-key (kbd "C-c C-h") 'hs-hide-block)    ;;折叠代码 (键绑定)
;;(global-set-key (kbd "C-c C-s") 'hs-show-block)    ;;打开折叠 (键绑定)
;;(global-set-key (kbd "C-c C-H") 'hs-hide-all)    ;;折叠全部代码 (键绑定)
;;(global-set-key (kbd "C-c C-S") 'hs-show-all)    ;;展开全部折叠 (键绑定)
...
;;windsize 用来调整多窗口中窗口的大小,不错挺好用的
(add-to-list 'load-path "~/.emacs.d/el-get/windsize/")
(require 'windsize)
(windsize-default-keybindings)

;;evil-nerd-commenter 用来做多行注释的
;; 这个功能非常强大
(add-to-list 'load-path "~/.emacs.d/el-get/evil-nerd-commenter/")
(require 'evil-nerd-commenter)
(evilnc-default-hotkeys)

;;;;window-numbering，窗口跳转的,个人感觉没啥用，因为窗口很少会开到三个或以上
;;;;会有键冲突，不太好用，真的要用，觉得应该需要改动一下键位
;;;;(add-to-list 'load-path "~/.emacs.d/el-get/window-numbering/")
...
;;这个组合键实在是太烦人了，注释掉
(global-set-key (kbd "C-x C-z") 'next-line)

;;(define-key key-translation-map [(control x z)] [(control n)])

;;ecb ide用的，先试一下，被我取消了，感觉并不好用
...
;;auto-complete 自动补全
(add-to-list 'load-path "~/.emacs.d/site-lisp/auto-complete")    ; This may not be appeared if you have already added.
...
;;auto-complete-clang，也是自动补全的，但是还不清楚有什么不同
...
(custom-set-variables
 ...
 '(custom-safe-themes (quote ("c3c0a3702e1d6c0373a0f6a557788dfd49ec9e66e753fb24493579859c8e95ab" "8db4b03b9ae654d4a57804286eb3e332725c84d7cdab38463cb6b97d5762ad26" "d677ef584c6dfc0697901a44b885cc18e206f05114c8a3b7fde674fce6180879" "1b7599764f7a28c63a3e433af764b6d32a82657b5edbfea87cb1fce783d36e89" default)))
